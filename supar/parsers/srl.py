...
class GnnLabelInteractionSemanticRoleLabelingParser(Parser):
    r"""
    TODO:introduction
    """

    NAME = 'gli-semantic-role-labeling'
    MODEL = GLISemanticRoleLabelingModel
