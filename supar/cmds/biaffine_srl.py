...
from supar import BiaffineSemanticRoleLabelingParser
from supar.cmds.cmd import parse


def main():
    parser = argparse.ArgumentParser(description='Create Biaffine Semantic SRL Parser.')
    parser.set_defaults(Parser=BiaffineSemanticRoleLabelingParser)
